         ...
         <div class="category-top">
            ...
            <c:choose>
                <c:when test="${cidParam == 1}">
                    <p>Trang chủ</p> <span>&#8594; </span> <p>Nike</p> <span>&#8594; </span> <p>Nam</p> <span>&#8594; </span> <p>Originals</p>
                </c:when>
                <c:when test="${cidParam == 2}">
                    <p>Trang chủ</p> <span>&#8594; </span> <p>Adidas</p> <span>&#8594; </span> <p>Nam</p> <span>&#8594; </span> <p>Originals</p>
                </c:when>
                <c:when test="${cidParam == 3}">
                    <p>Trang chủ</p> <span>&#8594; </span> <p>Converse</p> <span>&#8594; </span> <p>Nam</p> <span>&#8594; </span> <p>Originals</p>
                </c:when>
            </c:choose>
          </div>
        </div>
