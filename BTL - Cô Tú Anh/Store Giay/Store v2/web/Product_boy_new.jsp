<%-- 
    Document   : Product_boy_new
    Created on : May 22, 2024, 10:19:40 PM
...
<html lang="vi">
  <head>
    ...
    <link rel="stylesheet" href="/Store/css/Product_boy_new.css" />
         ...
         <div class="category-top">
            ...
            <c:choose>
                <c:when test="${cidParam == 1}">
                    <p>Trang chủ</p> <span>&#8594; </span> <p>Nike</p> <span>&#8594; </span> <p>Nam</p> <span>&#8594; </span> <p>Hàng nam mới về</p>
                </c:when>
                <c:when test="${cidParam == 2}">
                    <p>Trang chủ</p> <span>&#8594; </span> <p>Adidas</p> <span>&#8594; </span> <p>Nam</p> <span>&#8594; </span> <p>Hàng nam mới về</p>
                </c:when>
                <c:when test="${cidParam == 3}">
                    <p>Trang chủ</p> <span>&#8594; </span> <p>Converse</p> <span>&#8594; </span> <p>Nam</p> <span>&#8594; </span> <p>Hàng nam mới về</p>
                </c:when>
            </c:choose>
